...
The repository currently has no project-wide license. Selecting one remains an
explicit TODO. [`LICENSE.pierrec-lz4`](LICENSE.pierrec-lz4) is solely the
required third-party notice for the fast compressor algorithm.
